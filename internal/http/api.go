...
func NewApi(port int, game service.Game) Api {
	...
	api.addRoute(r, http.MethodPost, "/games/{id1}/add-deck", games.AddDeck)
	api.addRoute(r, http.MethodPost, "/games/{id1}/shuffle", games.Shuffle)
	...
	api.addRoute(r, http.MethodGet, "/games/{id1}/players", games.ListPlayers)
	api.addRoute(r, http.MethodPost, "/games/{id1}/players", games.AddPlayer)
	api.addRoute(r, http.MethodDelete, "/games/{id1}/players/{id2}", games.DeletePlayer)
	api.addRoute(r, http.MethodGet, "/games/{id1}/players/{id2}/cards", games.ListPlayersCards)
	api.addRoute(r, http.MethodPost, "/games/{id1}/players/{id2}/cards", games.PostPlayerCard)
